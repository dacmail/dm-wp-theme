<div class="post-share">
    ...
    <div class="share-buttons">
        ...
        <a title="Compartir en Twitter" href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php echo urlencode(get_the_title()); ?>&via=porCausaorg" class="icon tw" target="_blank"><i class="icon-ico_twitter"></i></a>
